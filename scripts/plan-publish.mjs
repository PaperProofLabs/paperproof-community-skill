...
const ADD_VERSION_BUILDERS = {
  preprint: 'addPreprintVersion({ ...input, controlRecordId, controllerNftId, versionChangeNote })',
  blogPost: 'addBlogPostVersion({ ...input, controlRecordId, controllerNftId, versionChangeNote })',
  technicalReport: 'addTechnicalReportVersion({ ...input, controlRecordId, controllerNftId, versionChangeNote })',
  dataset: 'addDatasetVersion({ ...input, controlRecordId, controllerNftId, versionChangeNote })',
  softwareRelease: 'addSoftwareReleaseVersion({ ...input, controlRecordId, controllerNftId, versionChangeNote })',
  genericFile: 'addGenericFileVersion({ ...input, controlRecordId, controllerNftId, versionChangeNote })',
};
