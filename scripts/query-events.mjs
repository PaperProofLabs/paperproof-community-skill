...
async function loadSdk() {
  try {
    ...
    throw new Error(`Cannot load @paperproof/sdk-ts. Install with: npm install @paperproof/sdk-ts@0.2.8 @mysten/sui. ${error instanceof Error ? error.message : String(error)}`);
  }
}
